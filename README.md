...
|---------|------|---------|
| **1.5.2** | 2026-08-23 | Fixed `LicenseUri`/`ProjectUri` in the manifest pointing at the wrong repository (`powershell-scripts` instead of `ADOpsKit`); same fix applied to the help topic and usage guide. No functional changes. Full details: [CHANGELOG.md](CHANGELOG.md#152--2026-08-23) |
