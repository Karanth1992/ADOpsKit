...
All notable changes to the **ADOpsKit** module are documented here.
Format follows [Keep a Changelog](https://keepachangelog.com/en/1.0.0/).

> ADSetupKit is a companion module maintained in its own repository —
> [github.com/Karanth1992/ADSetupKit](https://github.com/Karanth1992/ADSetupKit) —
> and keeps its own changelog there.
